...
/**
 * The number of minutes it takes to prepare all lasagna
 */
...
export function remainingMinutesInOven(actualMinutesInOven) {
  const MINUTES_REMAINING = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven
...
export function preparationTimeInMinutes(numberOfLayers) {
  const TOTAL_PREPARATION_TIME = numberOfLayers * PREPARATION_MINUTES_PER_LAYER
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  const TIME_PREPARING_ALL_LAYERS = numberOfLayers * PREPARATION_MINUTES_PER_LAYER
  let TotalWorkingTime = TIME_PREPARING_ALL_LAYERS + actualMinutesInOven
